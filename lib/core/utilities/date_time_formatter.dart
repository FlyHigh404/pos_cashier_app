...
class DateTimeFormatter {
  ...
  static String normalWithClock(String iso8601String) {
    ...
    return DateFormat('d MMMM y • HH:mm', 'id_ID').format(parsedDate);
  }
  ...
  static String detailedWithClock(String iso8601String) {
    ...
    return DateFormat('EEEE, d MMMM y • HH:mm', 'id_ID').format(parsedDate);
  }
  ...
  static String dayShorted(String iso8601String) {
    ...
    return DateFormat('EEE, d MMMM y', 'id_ID').format(parsedDate);
  }
