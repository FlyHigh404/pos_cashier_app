...
class HomeProvider extends ChangeNotifier {
  ...
  Future<Result<int>> createTransaction() async {
    try {
      ...
      final activeCashier = sessionProvider.activeCashierName;
      final String cashierName = activeCashier ?? 'Admin/Unknown';
  ...
  void onAddOrderedProduct(ProductEntity product, int qty) {
    ...
    if (currentIndex != -1) {
      final oldQty = orderedProducts[currentIndex].quantity;
